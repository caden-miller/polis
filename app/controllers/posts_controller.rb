class PostsController < ApplicationController
  ...
  def index
    ...
    # Filtering by political affiliation
    if params[:political_affiliation].present?
      @posts = @posts.joins(:user).where(users: { political_affiliation: params[:political_affiliation] })
    end
